    ...
    <>
      ...
      >
        ...
        <div className="absolute inset-0 w-full h-full">
          <img src={teamData?.banner_image} alt="" className="w-full h-full object-cover" />
        </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className={`max-w-4xl mx-auto text-center transition-all duration-1000 ${heroVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"}`}>
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold text-foreground mb-6 leading-tight lg:whitespace-nowrap" dangerouslySetInnerHTML={{ __html: addClassToSpan(teamData?.page_title, "bg-gradient-to-r from-[#5FC2E3] to-[#0077B6] bg-clip-text text-transparent") }}></h1>

            <p className="text-lg sm:text-xl text-muted-foreground max-w-3xl mx-auto" dangerouslySetInnerHTML={{ __html: teamData?.page_content }}></p>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className={`max-w-5xl mx-auto transition-all duration-1000 ${leadershipVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"}`}>
            ...
            <div className="text-center mb-12">
              ...
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-foreground mb-6" dangerouslySetInnerHTML={{ __html: addClassToSpan(teamData?.leadership_team_section?.heading, "bg-gradient-to-r from-[#5FC2E3] to-[#0077B6] bg-clip-text text-transparent") }}>
              </h2>

              <p className="text-base sm:text-lg text-muted-foreground leading-relaxed max-w-3xl mx-auto" dangerouslySetInnerHTML={{ __html: teamData?.leadership_team_section?.description }}>
              </p>
            </div>

            {/* Leadership Grid */}
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-8 lg:gap-10">
              {teamData?.leadership_team_section.teams.length > 0 && teamData?.leadership_team_section?.teams?.map((member, index) => (
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className={`max-w-4xl mx-auto transition-all duration-1000 ${architectsVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"}`}>
            ...
            <div className="text-center mb-12">
              ...
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-foreground mb-6" dangerouslySetInnerHTML={{ __html: addClassToSpan(teamData?.our_architects_section?.heading, "bg-gradient-to-r from-[#5FC2E3] to-[#0077B6] bg-clip-text text-transparent") }}>
              </h2>

              <p className="text-base sm:text-lg text-muted-foreground leading-relaxed max-w-3xl mx-auto" dangerouslySetInnerHTML={{ __html: teamData?.our_architects_section?.description }}>
              </p>
            </div>

            {/* Architects Grid */}
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-8 lg:gap-10 max-w-4xl mx-auto">
              {teamData?.our_architects_section?.teams.length > 0 && teamData?.our_architects_section?.teams.map((member, index) => (
      ...
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <Link to={teamData?.our_architects_section?.connection_section_url} className="block">
            <div
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row items-center relative z-10">
                ...
                <div className="flex-1 px-6 sm:px-8 lg:px-10 py-6 sm:py-8 lg:py-10 relative z-10">
                  ...
                  <h3 className="text-xl sm:text-2xl lg:text-3xl xl:text-4xl font-bold text-foreground mb-3 sm:mb-4 leading-[1.15]" dangerouslySetInnerHTML={{ __html: addClassToSpan(teamData?.our_architects_section?.connect_section_heading, "bg-gradient-to-r from-[#5FC2E3] to-[#0077B6] bg-clip-text text-transparent") }}>
                  </h3>
                  ...
                  <div className="inline-flex items-center gap-2 text-accent font-semibold text-sm sm:text-base group-hover:gap-3 transition-all duration-300 relative">
                    ...
                    <span className="ml-1">{teamData?.our_architects_section?.connect_section_text}</span>
                ...
                <div className="hidden sm:flex relative w-[28%] flex-shrink-0 h-[170px] lg:h-[210px] items-center justify-center">
                  ...
                  <div className="relative mr-8 sm:mr-10 lg:mr-12 w-[135px] h-[135px] lg:w-[170px] lg:h-[170px] rounded-full overflow-hidden border-4 border-accent/20 group-hover:border-accent/40 transition-all duration-500 shadow-[0_0_40px_rgba(92,200,220,0.1)] group-hover:shadow-[0_0_60px_rgba(92,200,220,0.2)]">
                    <img
                      src={teamData?.our_architects_section?.connect_section_image?.url}
                      alt={teamData?.our_architects_section?.connect_section_image?.alt}
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className={`max-w-4xl mx-auto transition-all duration-1000 ${engineersVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"}`}>
            ...
            <div className="text-center mb-12">
              ...
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-foreground mb-6" dangerouslySetInnerHTML={{ __html: addClassToSpan(teamData?.our_engineers_section?.heading, "bg-gradient-to-r from-[#5FC2E3] to-[#0077B6] bg-clip-text text-transparent") }}>
              </h2>

              <p className="text-base sm:text-lg text-muted-foreground leading-relaxed max-w-3xl mx-auto" dangerouslySetInnerHTML={{ __html: teamData?.our_engineers_section?.description }}>
              </p>
            </div>

            {/* Engineers Grid */}
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-8 lg:gap-10 max-w-4xl mx-auto">
              {teamData?.our_engineers_section?.teams.length > 0 && teamData?.our_engineers_section?.teams.map((member, index) => (
      ...
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <Link to={teamData?.our_engineers_section?.cta_url} className="block">
            <div
              ...
              <div className="flex flex-row items-center relative z-10">
                ...
                <div className="hidden sm:flex relative w-[28%] flex-shrink-0 h-[170px] lg:h-[210px] items-center justify-center">
                  ...
                  <div className="relative ml-8 sm:ml-10 lg:ml-12 w-[135px] h-[135px] lg:w-[170px] lg:h-[170px] rounded-full overflow-hidden border-4 border-accent/20 group-hover:border-accent/40 transition-all duration-500 shadow-[0_0_40px_rgba(92,200,220,0.1)] group-hover:shadow-[0_0_60px_rgba(92,200,220,0.2)]">
                    <img
                      src={teamData?.our_engineers_section?.connect_section_image?.url}
                      alt={teamData?.our_engineers_section?.connect_section_image?.alt}
                      className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110"
                    />
                  </div>
                </div>
                ...
                <div className="flex-1 px-6 sm:px-8 lg:px-10 py-6 sm:py-8 lg:py-10 relative z-10">
                  ...
                  <h3 className="text-xl sm:text-2xl lg:text-3xl xl:text-4xl font-bold text-foreground mb-3 sm:mb-4 leading-[1.15]" dangerouslySetInnerHTML={{ __html: addClassToSpan(teamData?.our_engineers_section?.connect_section_heading, "bg-gradient-to-r from-[#5FC2E3] to-[#0077B6] bg-clip-text text-transparent") }}>
                  </h3>

                  {/* CTA with pulse ring */}
                  <div className="inline-flex items-center gap-2 text-accent font-semibold text-sm sm:text-base group-hover:gap-3 transition-all duration-300 relative">
                    <span className="absolute -left-3 top-1/2 -translate-y-1/2 w-2 h-2 rounded-full bg-accent/60 group-hover:animate-ping" />
                    <span className="ml-1">{teamData?.our_engineers_section?.connect_section_text}</span>
                    <ArrowRight className="w-4 h-4 sm:w-5 sm:h-5 group-hover:translate-x-1 transition-transform duration-300" />
                  </div>
                </div>
              </div>
        ...
        <div className={`container mx-auto px-4 sm:px-6 lg:px-8 transition-all duration-1000 delay-300 ${engBannerVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"}`}>
          <div className="max-w-2xl mx-auto text-center">
            <h3 className="text-xl sm:text-2xl font-semibold text-foreground mb-4">
              {teamData?.join_us_section?.heading}
            </h3>

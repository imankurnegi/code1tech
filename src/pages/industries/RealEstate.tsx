...
const RealEstateChallengesPinned = ({ challengeItems, challengesSection, cta_section_70 }: { challengeItems: any[]; challengesSection: any; cta_section_70: any }) => {
...
const RealEstateTechShowcase = ({ techStack, technologiesSection, cta_section_111 }: { techStack: any[]; technologiesSection: any; cta_section_111: any }) => {
  const [active, setActive] = useState(0);
...
const challengesSection = pageData?.key_challenges_in_real_estate_operations;
const solutionsSection = pageData?.real_estate_software_solutions_we_deliver;
...
const turningRealEstateSection = pageData?.turning_real_estate_operations_into_sustainable_growth;
...
const heroBlocks = heroBanner?.blocks?.map((block: any) => ({
  ...
  return (
    <>
      ...
      {/* ================= KEY CHALLENGES ================= */}
      <RealEstateChallengesPinned challengeItems={challengeItems} challengesSection={challengesSection} cta_section_70={cta_section_70} />
      ...
      {/* ================= TECHNOLOGIES ================= */}
      <RealEstateTechShowcase techStack={techStack} technologiesSection={technologiesSection} cta_section_111={cta_section_111} />
      ...
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <CTABanner
            text={cta_section_130?.content || ""}
            buttonText={cta_section_130?.button_text || ""}
            linkUrl={cta_section_130?.button_url || ""}
          />
        </div>
      </section>

      {/* ================= ENGAGEMENT MODELS IMAGE ================= */}
      <section
        className="py-8 lg:py-12 relative overflow-hidden"
        style={{ background: "linear-gradient(180deg, hsl(222 47% 6%) 0%, hsl(222 47% 8%) 50%, hsl(222 47% 6%) 100%)" }}
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          {/* Infographic Frame */}
          <div className="relative rounded-2xl overflow-hidden border border-[#5FC2E3]/30 shadow-2xl bg-[#0B1628]/70">
            {/* Ambient glow */}
            <div
              className="absolute -inset-4 opacity-20 blur-3xl rounded-full pointer-events-none"
              style={{
                background: "radial-gradient(circle at 50% 50%, #5FC2E3 0%, transparent 70%)",
              }}
            />
            {/* Corner accent */}
            <div className="absolute top-0 left-0 w-24 h-24 border-l-2 border-t-2 border-cyan-400/50 rounded-tl-2xl pointer-events-none" />
            <div className="absolute bottom-0 right-0 w-24 h-24 border-r-2 border-b-2 border-[#0077B6]/50 rounded-br-2xl pointer-events-none" />
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            <div className="order-2 lg:order-1">
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground mb-6 text-left" dangerouslySetInnerHTML={{ __html: addClassToSpan(turningRealEstateSection?.heading, "bg-gradient-to-r from-[#5FC2E3] to-[#0077B6] bg-clip-text text-transparent") }} />
              <p className="text-base sm:text-lg text-muted-foreground leading-[1.8] mb-8 text-left">
                {turningRealEstateSection?.paragraph || ""}
              </p>
              <Link to={turningRealEstateSection?.button_url || ""}>
                <Button
                  size="lg"
                ...
                >
                  {turningRealEstateSection?.button_text || ""}
                  <ArrowRight className="w-5 h-5 ml-2 group-hover:translate-x-2 transition-transform" />
                </Button>
              </Link>
            </div>
            <div className="order-1 lg:order-2">
              <div className="relative rounded-2xl overflow-hidden border border-accent/15 shadow-[0_8px_40px_rgba(0,119,182,0.2)]">
                <img
                  src={turningRealEstateSection?.image?.url || ""}
                  alt={turningRealEstateSection?.image?.alt || ""}
                  className="w-full h-auto object-cover"
                  width={turningRealEstateSection?.image?.width || 1280}
                  height={turningRealEstateSection?.image?.height || 960}
                  loading="eager" decoding="async"
                />

...
const HealthcareBenefitsPinned = ({ benefitItems, benefitsSection }: { benefitItems: any[]; benefitsSection: any }) => {
...
const HealthcareTechShowcase = ({ techStack, technologiesSection, cta_section_77 }: { techStack: any[]; technologiesSection: any; cta_section_77: any }) => {
  const [active, setActive] = useState(0);
...
const benefitsSection = pageData?.how_healthcare_organizations_benefit_from_advanced_solutions;
const solutionsSection = pageData?.healthcare_solutions_we_deliver;
const technologiesSection = pageData?.technologies_that_power_connected_healthcare;
const outcomesSection = pageData?.business_outcomes_that_improve_patient_care;
const workflowImage = pageData?.our_healthcare_development_workflow?.image;
const engagementModelsImage = pageData?.flexible_engagement_models?.image;
const whyChooseSection = pageData?.reasons_why_healthcare_institutions_opt_for_code1_technologies;
...
const heroBlocks = heroBanner?.blocks?.map((block: any) => ({
  ...
  return (
    <>
      ...
      {/* ================= INFOGRAPHIC: HOW HEALTHCARE BENEFITS ================= */}
      <HealthcareBenefitsPinned benefitItems={benefitItems} benefitsSection={benefitsSection} />
      ...
      {/* ================= TECHNOLOGIES ================= */}
      <HealthcareTechShowcase techStack={techStack} technologiesSection={technologiesSection} cta_section_77={cta_section_77} />
      ...
      >
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="mb-10 rounded-2xl overflow-hidden border border-white/10 bg-gradient-to-br from-white/[0.04] to-white/[0.01] shadow-[0_30px_80px_rgba(0,0,0,0.55),0_0_60px_rgba(95,194,227,0.15)]">
            <img
              src={workflowImage?.url || ""}
              alt={workflowImage?.alt || ""}
              width={workflowImage?.width || 1920}
              height={workflowImage?.height || 1080}
              loading="eager" decoding="async"
              className="w-full h-auto object-cover"
            />
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-10 rounded-2xl overflow-hidden border border-white/10 bg-gradient-to-br from-white/[0.04] to-white/[0.01] shadow-[0_30px_80px_rgba(0,0,0,0.55),0_0_60px_rgba(95,194,227,0.15)]">
            <img
              ...
              width={engagementModelsImage?.width || 1920}
              height={engagementModelsImage?.height || 1080}
              loading="eager" decoding="async"
              className="w-full h-auto object-cover"
            />
          </div>
      ...
      >
        <div className="absolute inset-0 pointer-events-none" style={{ background: "radial-gradient(ellipse at center, rgba(0,119,182,0.18), transparent 60%)" }} />
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-5xl mb-10 lg:mb-14 mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 lg:gap-5 mb-10 lg:mb-14">
              ...
              return (
                <div key={index} className="relative">
                  <div
                    ...
                    style={{
                      background: "linear-gradient(180deg, #0E1525 0%, #0B1220 100%)",
                      border: "1px solid rgba(148,163,184,0.15)",
                      boxShadow: "0 4px 32px rgba(0,0,0,0.4)",
                    }}
                  >
                    <div className="px-4 pt-5 pb-5 flex flex-col h-full">
                      <div className="relative aspect-[4/3] mb-4 rounded-xl overflow-hidden bg-[#0E1525]">
                        <img
                          src={item.image?.url || ""}
                          alt={item.title}
                      ...
                      <div className="w-10 h-0.5 bg-gradient-to-r from-[#5FC2E3] to-[#0077B6] mx-auto mb-3" />
                  ...
                  {index < whyChooseItems.length - 1 && (
                    <div
                      className="hidden lg:flex absolute top-1/2 -right-3 items-center gap-1"
                      style={{ transform: "translateY(-50%)", width: "24px" }}
                    >
                      <div className="w-1.5 h-1.5 rounded-full bg-[#5FC2E3]" />
                      <div className="flex-1 h-px bg-gradient-to-r from-[#5FC2E3]/70 to-[#0077B6]/70" />

...
const GlassCard = ({ item }: { item: CardItem }) => (
  <div className="group relative h-full p-[1px] rounded-2xl overflow-hidden transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl hover:shadow-accent/20">
...
const engagementModelsSection = pageData?.flexible_industry_cards;
const whyChooseSection = pageData?.why_choose_industry_image_and_content;
...
const engagementModels = engagementModelsSection?.cards?.map((card: any) => ({
  icon: card.icon,
  title: card.title,
  desc: card.content,
})) || [];
...
const whyChooseItems =
  whyChooseSection?.lists?.map((item: any) =>
  ...
  return (
    <>
      ...
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-5xl mb-10 mx-auto text-center">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground tracking-tight text-center mb-5" dangerouslySetInnerHTML={{ __html: addClassToSpan(businessOutcomesSection?.heading, "bg-gradient-to-r from-[#5FC2E3] to-[#0077B6] bg-clip-text text-transparent") }} />
            <p className="text-base text-muted-foreground leading-[1.75] text-center">
              {businessOutcomesSection?.paragraph}
            </p>
          </div>
      ...
      <section className="py-8 lg:py-12 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-5xl mb-10 mx-auto text-center">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground tracking-tight text-center mb-5" dangerouslySetInnerHTML={{ __html: addClassToSpan(ourServicesSection?.heading, "bg-gradient-to-r from-[#5FC2E3] to-[#0077B6] bg-clip-text text-transparent") }} />
            <p className="text-base text-muted-foreground leading-[1.75] text-center">
              {ourServicesSection?.paragraph}
            </p>
          </div>
      ...
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-5xl mb-8 mx-auto text-center">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground tracking-tight text-center mb-5" dangerouslySetInnerHTML={{ __html: addClassToSpan(aiSolutionsSection?.heading, "bg-gradient-to-r from-[#5FC2E3] to-[#0077B6] bg-clip-text text-transparent") }} />
            <p className="text-base text-muted-foreground leading-[1.75] text-center">
              {aiSolutionsSection?.paragraph}
            </p>
          </div>
      ...
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-5xl mb-8 mx-auto text-center">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground tracking-tight text-center mb-5" dangerouslySetInnerHTML={{ __html: addClassToSpan(businessChallengesSection?.heading, "bg-gradient-to-r from-[#5FC2E3] to-[#0077B6] bg-clip-text text-transparent") }} />
            <p className="text-base text-muted-foreground leading-[1.75] text-center">
              {businessChallengesSection?.paragraph}
            </p>
          </div>
      ...
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-5xl mb-8 mx-auto text-center">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground tracking-tight text-center mb-5" dangerouslySetInnerHTML={{ __html: addClassToSpan(techStackSection?.heading, "bg-gradient-to-r from-[#5FC2E3] to-[#0077B6] bg-clip-text text-transparent") }} />
            <p className="text-base text-muted-foreground leading-[1.75] text-center">
              {techStackSection?.paragraph}
            </p>
          </div>
      ...
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-5xl mb-8 mx-auto text-center">
            ...
            <p className="text-base text-muted-foreground leading-[1.75] text-center">
              {engagementModelsSection?.paragraph}
            </p>
          </div>

        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {engagementModels.map((e) => (
            <GlassCard key={e.title} item={e} />
          ))}
        </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            <div className="order-2 lg:order-1">
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground mb-6 text-left" dangerouslySetInnerHTML={{ __html: addClassToSpan(whyChooseSection?.heading, "bg-gradient-to-r from-[#5FC2E3] to-[#0077B6] bg-clip-text text-transparent") }} />
              <div className="space-y-4 mb-8">
                {whyChooseItems.map((item, index) => (
                  <div key={index} className="flex items-start gap-3">
                    <DynamicIcon name="lucide-check-circle-2" className="w-5 h-5 text-accent flex-shrink-0 mt-0.5" />
                    <span className="text-sm sm:text-base text-muted-foreground leading-relaxed text-left">{item}</span>
                  </div>
                ))}
              </div>
              <Link to={whyChooseSection?.button_url}>
                <Button
                  size="lg"

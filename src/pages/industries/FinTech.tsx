...
const corePrinciplesImage = pageData?.our_core_fintech_principles?.image;
const solutionsSection = pageData?.fintech_solutions_we_deliver;
const consultingProcessImage = pageData?.our_consulting_development_process?.image;
const technologiesSection = pageData?.technologies_that_power_your_fintech_business;
const engagementModelsImage = pageData?.flexible_engagement_models?.image;
const outcomesSection = pageData?.business_outcomes_that_strengthen_financial_performance_and_customer_trust;
const transformSection = pageData?.transform_financial_innovation_into_business_growth;
  ...
  return (
    ...
    <SeoTags
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-6xl mx-auto">
            <div className="relative group">
              ...
              <div
                aria-hidden="true"
                className="absolute -inset-6 rounded-[2rem] blur-3xl opacity-60 group-hover:opacity-90 transition-opacity duration-700"
                style={{
                  background:
              ...
              <div className="relative rounded-2xl p-[1.5px] bg-gradient-to-br from-accent/60 via-primary/30 to-accent/60">
                ...
                >
                  <img
                    src={corePrinciplesImage?.url || ""}
                    alt={corePrinciplesImage?.alt || ""}
                    className="w-full h-auto block transition-transform duration-700 group-hover:scale-[1.01]"
                    loading="eager" decoding="async"
                    width={corePrinciplesImage?.width || 1742}
                    height={corePrinciplesImage?.height || 903}
                  />
      ...
      <section className="py-8 lg:py-12 relative overflow-hidden">
        {/* Dark theme background matching other website sections */}
        <div
          className="absolute inset-0"
          style={{
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="relative max-w-6xl mx-auto group">
            ...
            <div className="relative rounded-2xl p-[1.5px] bg-gradient-to-br from-accent/60 via-primary/30 to-accent/60">
              ...
              >
                <img
                  src={consultingProcessImage?.url || ""}
                  alt={consultingProcessImage?.alt || ""}
                  className="w-full h-auto block transition-transform duration-700 group-hover:scale-[1.01]"
                  loading="eager" decoding="async"
                  width={consultingProcessImage?.width || 1774}
                  height={consultingProcessImage?.height || 887}
                />
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="relative max-w-6xl mx-auto group">
            ...
            <div className="relative rounded-2xl p-[1.5px] bg-gradient-to-br from-accent/60 via-primary/30 to-accent/60">
              ...
              >
                <img
                  src={engagementModelsImage?.url || ""}
                  alt={engagementModelsImage?.alt || ""}
                  className="w-full h-auto block transition-transform duration-700 group-hover:scale-[1.01]"
                  loading="eager" decoding="async"
                  width={engagementModelsImage?.width || 1690}
                  height={engagementModelsImage?.height || 931}
                />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-5">
            {outcomes.map((o) => (
              ...
              >
                ...
                <div className="p-5">
                  <h3 className="text-base font-bold text-foreground mb-2 group-hover:text-accent transition-colors line-clamp-2 min-h-[3rem] flex items-center">
                    {o.title}
                  </h3>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            <div className="order-2 lg:order-1">
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground mb-6 text-left" dangerouslySetInnerHTML={{ __html: addClassToSpan(transformSection?.heading, "bg-gradient-to-r from-[#5FC2E3] to-[#0077B6] bg-clip-text text-transparent") }} />
              <p className="text-base sm:text-lg text-muted-foreground leading-[1.8] mb-8 text-left">
                {transformSection?.paragraph || ""}
              </p>
              <Link to={transformSection?.button_url || ""}>
                <Button
                  size="lg"
            ...
            <div className="order-1 lg:order-2">
              <div className="relative rounded-2xl overflow-hidden border border-accent/15 shadow-[0_8px_40px_rgba(0,119,182,0.2)]">
                <img
                  src={transformSection?.image?.url || ""}
                  alt={transformSection?.image?.alt || ""}
                  className="w-full h-auto object-cover"
                  width={transformSection?.image?.width || 1280}
                  height={transformSection?.image?.height || 960}
                  loading="eager" decoding="async"
                />
      ...
      {/* ================= WHY CHOOSE CODE1 TECH SYSTEMS INFOGRAPHIC ================= */}
      <section
        className="py-8 lg:py-12 relative overflow-hidden"
        style={{
          background:
            ...
            <div className="relative rounded-2xl p-[1.5px] bg-gradient-to-br from-accent/60 via-primary/30 to-accent/60">
              ...
              >
                <img
                  ...
                  className="w-full h-auto block transition-transform duration-700 group-hover:scale-[1.01]"
                  loading="eager" decoding="async"
                  width={whyChooseInfographicImage?.width || 1774}
                  height={whyChooseInfographicImage?.height || 887}
                />

...
const ProtechChallengesPinned = ({ challengeItems, challengesSection, cta_section_70 }: { challengeItems: any[]; challengesSection: any; cta_section_70: any }) => {
  ...
  return (
    ...
    >
      <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
        ...
        <div className="absolute inset-0 opacity-[0.035]" style={{ backgroundImage: "linear-gradient(rgba(95,194,227,0.5) 1px, transparent 1px), linear-gradient(90deg, rgba(95,194,227,0.5) 1px, transparent 1px)", backgroundSize: "64px 64px", maskImage: "radial-gradient(ellipse at center, black 40%, transparent 85%)" }} />
      </div>
            ...
            return (
              ...
              >
                ...
                <div className="flex items-start gap-3">
                  <span className={`font-mono text-sm font-bold shrink-0 transition-colors ${isActive ? "text-accent" : "text-muted-foreground group-hover/tab:text-foreground/70"}`}>
                    {it.num}
                  </span>
                  <span className={`text-sm md:text-[0.95rem] font-semibold leading-snug transition-colors ${isActive ? "text-foreground" : "text-muted-foreground group-hover/tab:text-foreground/80"}`}>
                    {it.title}
                  </span>
                </div>
              </button>
...
const ProtechTechShowcase = ({ techStack, technologiesSection, cta_section_111 }: { techStack: any[]; technologiesSection: any; cta_section_111: any }) => {
  const [active, setActive] = useState(0);
  ...
  return (
    ...
    >
      <div aria-hidden className="absolute inset-0 pointer-events-none">
        <div className="absolute inset-0 opacity-[0.07]" style={{ backgroundImage: "linear-gradient(hsl(194 68% 63% / 0.3) 1px, transparent 1px), linear-gradient(90deg, hsl(194 68% 63% / 0.3) 1px, transparent 1px)", backgroundSize: "56px 56px", maskImage: "radial-gradient(ellipse at center, black 30%, transparent 75%)", WebkitMaskImage: "radial-gradient(ellipse at center, black 30%, transparent 75%)" }} />
              ...
              <div key={active} className="relative p-8 lg:p-12 animate-fade-in min-h-[420px] flex flex-col">
                <div className="flex items-start justify-between gap-6 mb-8">
                  ...
                  <div className="text-right">
                    <div className="font-mono text-[10px] tracking-[0.3em] text-muted-foreground mb-1">MODULE</div>
...
const challengesSection = pageData?.build_smarter_saas_products_through_digital_innovation;
const solutionsSection = pageData?.build_secure_scalable_saas_solutions;
...
const processSection = pageData?.our_consulting_development_process;
...
const buildFutureSection = pageData?.turning_ideas_into_scalable_saas_success;
...
const heroBlocks = heroBanner?.blocks?.map((block: any) => ({
  ...
  return (
    <>
      ...
      >
        <div className="absolute inset-0 opacity-[0.06] pointer-events-none" style={{ backgroundImage: "linear-gradient(rgba(95,194,227,0.5) 1px, transparent 1px), linear-gradient(90deg, rgba(95,194,227,0.5) 1px, transparent 1px)", backgroundSize: "48px 48px", maskImage: "radial-gradient(ellipse at center, black 40%, transparent 80%)" }} />
      ...
      {/* ================= KEY FOCUS AREAS ================= */}
      <ProtechChallengesPinned challengeItems={challengeItems} challengesSection={challengesSection} cta_section_70={cta_section_70} />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-5 mb-12 auto-rows-fr">
            {solutions.map((s, idx) => {
              ...
              return (
                <div
                  key={s.title}
                  className={`group relative p-[1px] rounded-2xl overflow-hidden transition-all duration-500 hover:shadow-2xl hover:shadow-accent/20 ${
                    isFeatured
                ...
                >
                  ...
                  <div
                    className={`relative h-full bg-[hsl(222_47%_7%)]/90 backdrop-blur-2xl rounded-2xl border border-foreground/5 overflow-hidden ${
                      isFeatured
                        ? "p-8 lg:p-10 flex flex-col lg:flex-row lg:items-center gap-6 lg:gap-10"
                    ...
                    {isFeatured ? (
                      <>
                        ...
                        <div className="flex-1">
                          <h3 className="text-xl lg:text-2xl font-bold text-foreground leading-tight text-left mb-3">
                            {s.title}
                          </h3>
                          <p className="text-sm lg:text-base text-muted-foreground leading-relaxed text-left max-w-3xl">
                            {s.desc}
                          </p>
                        </div>
                      </>
      ...
      {/* ================= TECHNOLOGIES ================= */}
      <ProtechTechShowcase techStack={techStack} technologiesSection={technologiesSection} cta_section_111={cta_section_111} />
      ...
      <section className="py-8 lg:py-12 relative overflow-hidden" style={{ background: "linear-gradient(180deg, hsl(222 47% 6%) 0%, hsl(222 47% 8%) 50%, hsl(222 47% 6%) 100%)" }}>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-5xl mb-8 mx-auto text-center">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground tracking-tight text-center mb-5" dangerouslySetInnerHTML={{ __html: addClassToSpan(processSection?.heading, "bg-gradient-to-r from-[#5FC2E3] to-[#0077B6] bg-clip-text text-transparent") }} />
          </div>
          <div className="relative rounded-2xl overflow-hidden border border-white/10 shadow-[0_8px_40px_rgba(0,0,0,0.55)] mb-8">
            <img
              src={processSection?.image?.url || ""}
              alt={processSection?.image?.alt || ""}
              className="w-full h-auto object-cover"
              width={processSection?.image?.width || 1920}
              height={processSection?.image?.height || 1080}
              loading="eager"
              decoding="async"
            />
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative rounded-2xl overflow-hidden border border-white/10 shadow-[0_8px_40px_rgba(0,0,0,0.55)] mb-8">
            <img
              ...
              className="w-full h-auto object-cover"
              width={engagementModelsSection?.image?.width || 1920}
              height={engagementModelsSection?.image?.height || 1080}
              loading="eager"
              decoding="async"
            />
          </div>
          <CTABanner
            text={cta_section_131?.content || ""}
            buttonText={cta_section_131?.button_text || ""}
            linkUrl={cta_section_131?.button_url || ""}
          />
        </div>
      </section>

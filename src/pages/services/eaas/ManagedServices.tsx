  ...
  return (
    <div>
      ...
      >
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 pt-8 lg:pt-12">
          <div className="grid lg:grid-cols-[5fr_6fr] gap-8 lg:gap-12 items-center">
            ...
            {/* Left — Image (CSS entrance animation, not observer) */}
            <div style={{ animation: "heroSlideInLeft 0.6s ease-out both" }}>
              <div className="relative">
                ...
                {/* Floating badges — from API or static fallback */}
          ...
          {stats.length > 0 ? (
            ...
            <div className="mt-10 grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-6 p-4 sm:p-6 rounded-2xl backdrop-blur-2xl hover:scale-[1.01]" style={{ background: "linear-gradient(135deg, rgba(255,255,255,0.06) 0%, rgba(95,194,227,0.04) 50%, rgba(255,255,255,0.03) 100%)", border: "1px solid rgba(95, 194, 227, 0.15)", boxShadow: "0 10px 40px rgba(0, 0, 0, 0.35), inset 0 1px 0 rgba(255,255,255,0.05), 0 0 30px rgba(95,194,227,0.05)", animation: "heroFadeUp 0.8s ease-out 1s both" }}>
      ...
      {(introSection.heading || introSection.left_content || introBlocks.length > 0) && (
        <section id="intro" ref={setSectionRef("intro")} className="py-12 lg:py-16" style={{ background: "linear-gradient(180deg, hsl(222 47% 5%) 0%, hsl(222 47% 6%) 100%)" }}>
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            {introSection.heading && (
              <div className={`text-center mx-auto mb-10 transition-all duration-700 ${visibleSections.intro ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
                <h2
            ...
            <div className="grid lg:grid-cols-2 gap-10 lg:gap-14 items-stretch max-w-6xl mx-auto">
              ...
              {introSection.left_content && (
                <div className={`order-1 flex flex-col justify-center transition-all duration-700 ${visibleSections.intro ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
              ...
              {introBlocks.length > 0 && (
                <div className={`relative order-2 flex transition-all duration-700 ${visibleSections.intro ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`} style={{ transitionDelay: "150ms" }}>
                    ...
                    <div className="grid grid-cols-2 gap-4 flex-1">
                      {introBlocks.map((block: any, i: number) => (
                        <div key={i} className="flex flex-col items-start justify-between gap-3 p-5 rounded-xl border border-border/30 min-h-[120px]" style={{ background: i % 2 === 0 ? "linear-gradient(135deg, rgba(95,194,227,0.12), rgba(95,194,227,0.03))" : "linear-gradient(135deg, rgba(0,119,182,0.12), rgba(0,119,182,0.03))" }}>
                          ...
                          <span className="text-foreground/90 text-sm font-medium leading-tight">{block.title}</span>
                        </div>
                      ))}
                    </div>
      ...
      {(whyNeedSection.heading || whyNeedBlocks.length > 0) && (
        <section id="whyneed" ref={setSectionRef("whyneed")} className="py-12 lg:py-16" style={{ background: "linear-gradient(180deg, hsl(222 47% 6%) 0%, hsl(220 50% 8%) 50%, hsl(222 47% 6%) 100%)" }}>
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className={`text-center mb-10 transition-all duration-700 ${visibleSections.whyneed ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
            ...
            {whyNeedBlocks.length > 0 && (
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {whyNeedBlocks.map((b: any, i: number) => (
                  <Card key={i} className={`bg-card/40 border-border/30 backdrop-blur-sm hover:border-primary/50 transition-all duration-500 ${visibleSections.whyneed ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`} style={{ transitionDelay: `${i * 70}ms` }}>
      ...
      {(compareSection.heading || compareCards.length > 0) && (
        <section id="compare" ref={setSectionRef("compare")} className="py-12 lg:py-16" style={{ background: "linear-gradient(180deg, hsl(222 47% 5%) 0%, hsl(222 47% 6%) 100%)" }}>
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className={`text-center mb-10 transition-all duration-700 ${visibleSections.compare ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
            ...
            {compareCards.length > 0 && (
              <div className="grid lg:grid-cols-2 gap-6 max-w-6xl mx-auto">
                {/* Traditional */}
                <div className={`p-6 rounded-xl border border-destructive/20 bg-destructive/5 transition-all duration-700 ${visibleSections.compare ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
                  <div className="flex items-center gap-3 mb-5">
                    <div className="w-10 h-10 rounded-lg bg-destructive/15 flex items-center justify-center">
                      <XCircle className="w-5 h-5 text-destructive" />
                    </div>
                    <h3 className="text-lg font-bold text-foreground">Traditional IT</h3>
                  </div>
                  <div className="space-y-4">
                    {traditionalCards.map((c: any, i: number) => (
                      <div key={i} className="border-l-2 border-destructive/40 pl-4">
                        ...
                        <p className="text-muted-foreground text-xs leading-relaxed text-left" dangerouslySetInnerHTML={{ __html: c.content ?? c.description ?? "" }} />
                      </div>
                    ))}
                  </div>
                </div>
                {/* Managed */}
                <div className={`p-6 rounded-xl border border-accent/30 bg-accent/5 transition-all duration-700 ${visibleSections.compare ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`} style={{ transitionDelay: "150ms" }}>
                  <div className="flex items-center gap-3 mb-5">
                    <div className="w-10 h-10 rounded-lg bg-accent/15 flex items-center justify-center">
                      <CheckCircle className="w-5 h-5 text-accent" />
                    </div>
                    <h3 className="text-lg font-bold text-foreground">Managed IT (Our Approach)</h3>
                  </div>
                  <div className="space-y-4">
                    {managedCards.map((c: any, i: number) => (
      ...
      {(coreSection.heading || coreCards.length > 0) && (
        <section id="core" ref={setSectionRef("core")} className="py-12 lg:py-16" style={{ background: "linear-gradient(180deg, hsl(222 47% 6%) 0%, hsl(220 50% 8%) 50%, hsl(222 47% 6%) 100%)" }}>
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className={`text-center mb-10 transition-all duration-700 ${visibleSections.core ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
              {coreSection.heading && (
                <h2
                  className="text-2xl sm:text-3xl lg:text-4xl font-bold text-foreground mb-4"
            ...
            {coreCards.length > 0 && (
              <div className="grid lg:grid-cols-2 gap-6 max-w-6xl mx-auto">
                {coreCards.map((s: any, i: number) => (
                  <Card key={i} className={`bg-card/40 border-border/30 backdrop-blur-sm hover:border-primary/50 transition-all duration-500 ${i === coreCards.length - 1 && coreCards.length % 2 === 1 ? "lg:col-span-2" : ""} ${visibleSections.core ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`} style={{ transitionDelay: `${i * 80}ms` }}>
                    <CardContent className="p-6">
      ...
      {(processSection.heading || processCards.length > 0) && (
        <section id="process" ref={setSectionRef("process")} className="py-12 lg:py-16" style={{ background: "linear-gradient(180deg, hsl(222 47% 5%) 0%, hsl(222 47% 6%) 100%)" }}>
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className={`text-center mb-10 transition-all duration-700 ${visibleSections.process ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
            ...
            {processCards.length > 0 && (
              <div className="relative grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-4 max-w-6xl mx-auto">
                {processCards.map((item: any, i: number) => (
                  <div key={i} className={`group relative transition-all duration-500 ${visibleSections.process ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`} style={{ transitionDelay: `${i * 100}ms` }}>
                    ...
                    <div className="relative flex flex-col items-center bg-[hsl(222,47%,7%)] border border-white/10 rounded-2xl p-8 h-full transition-transform duration-300 group-hover:-translate-y-2">
                      ...
                      <div className="font-mono text-[10px] tracking-widest text-[#5FC2E3]/60 uppercase mb-2">Step {i + 1}</div>
                      <h3 className="text-xl font-bold mb-3 text-foreground text-center">{item.title}</h3>
      ...
      {(whyChooseSection.heading || whyChooseCards.length > 0) && (
        <section id="whychoose" ref={setSectionRef("whychoose")} className="relative py-12 lg:py-16 overflow-hidden" style={{ background: "linear-gradient(180deg, hsl(222 47% 6%) 0%, hsl(220 50% 8%) 50%, hsl(222 47% 6%) 100%)" }}>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className={`max-w-6xl mx-auto mb-10 transition-all duration-700 ${visibleSections.whychoose ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
              ...
              <div className="max-w-6xl mx-auto grid lg:grid-cols-12 gap-4">
                {whyChooseCards.map((b: any, i: number) => {
                  ...
                  return (
                    <article
                      key={i}
                      className={`group relative overflow-hidden rounded-2xl border border-border/30 bg-card/40 backdrop-blur-sm transition-all duration-500 hover:border-[#5FC2E3]/50 hover:-translate-y-0.5 ${featured ? "lg:col-span-12" : "lg:col-span-6"} ${visibleSections.whychoose ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
      ...
      {(industriesSection.heading || industryCards.length > 0) && (
        <section id="industries" ref={setSectionRef("industries")} className="py-12 lg:py-16" style={{ background: "linear-gradient(180deg, hsl(222 47% 5%) 0%, hsl(222 47% 6%) 100%)" }}>
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className={`text-center mb-10 transition-all duration-700 ${visibleSections.industries ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
            ...
            {industryCards.length > 0 && (
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4 max-w-5xl mx-auto">
                {industryCards.map((it: any, i: number) => (
                  <div key={i} className={`p-5 rounded-xl border border-border/30 bg-card/30 backdrop-blur-sm hover:border-primary/40 hover:-translate-y-1 transition-all duration-500 text-center ${visibleSections.industries ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`} style={{ transitionDelay: `${i * 60}ms` }}>
      ...
      {(plansSection.heading || planCards.length > 0) && (
        <section id="plans" ref={setSectionRef("plans")} className="py-12 lg:py-16" style={{ background: "linear-gradient(180deg, hsl(222 47% 6%) 0%, hsl(220 50% 8%) 50%, hsl(222 47% 6%) 100%)" }}>
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className={`text-center mb-10 transition-all duration-700 ${visibleSections.plans ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
            ...
            {planCards.length > 0 && (
              <div className="grid md:grid-cols-3 gap-6 max-w-6xl mx-auto">
                {planCards.map((p: any, i: number) => (
                  <Card key={i} className={`bg-card/40 border-border/30 backdrop-blur-sm hover:border-primary/50 transition-all duration-500 ${i === 1 ? "lg:scale-105 border-accent/40" : ""} ${visibleSections.plans ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`} style={{ transitionDelay: `${i * 100}ms` }}>
                    <CardContent className="p-6">
      ...
      {(takeItOff.heading || getStarted.heading || growthSection.heading) && (
        <section id="take-it-off" ref={setSectionRef("take-it-off")} className="relative py-12 lg:py-16 overflow-hidden" style={{ background: "linear-gradient(180deg, hsl(222 47% 6%) 0%, hsl(220 50% 8%) 50%, hsl(222 47% 6%) 100%)" }}>
          <div className="absolute inset-0 pointer-events-none overflow-hidden">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className={`max-w-6xl mx-auto transition-all duration-700 ${visibleSections["take-it-off"] ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
              <div className="grid lg:grid-cols-[1.05fr_0.95fr] gap-6 lg:gap-0 items-stretch">
                ...
                <div className="relative rounded-2xl lg:rounded-r-none p-8 sm:p-10 lg:p-12 overflow-hidden flex flex-col justify-between" style={{ background: "linear-gradient(135deg, rgba(95,194,227,0.06) 0%, rgba(10,15,30,0.85) 45%, rgba(0,119,182,0.08) 100%)", border: "1px solid rgba(95,194,227,0.18)", borderRight: "1px dashed rgba(95,194,227,0.25)" }}>
                  ...
                  <div className="relative z-10">
                    {takeItOff.heading ? (
                      <h2
                        ...
                        dangerouslySetInnerHTML={{ __html: addClassToSpan(takeItOff.heading, "bg-gradient-to-r from-[#5FC2E3] to-[#0077B6] bg-clip-text text-transparent") }}
                      />
                    ) : (
                    ...
                    {takeItOff.content && (
                      <p className="text-muted-foreground text-sm sm:text-base leading-relaxed text-left max-w-md" dangerouslySetInnerHTML={{ __html: takeItOff.content }} />
                    )}
                  </div>
                  {Array.isArray(takeItOff.bottom_label) && takeItOff.bottom_label.length > 0 && (
                    <div className="relative z-10 mt-8 pt-6 flex items-center gap-6 text-[11px] font-mono uppercase tracking-wider text-muted-foreground/70" style={{ borderTop: "1px dashed rgba(148,163,184,0.18)" }}>
                      {takeItOff.bottom_label.map((label: any, i: number) => (
                        <span key={i} className="flex items-center gap-1.5"><span className="w-1 h-1 rounded-full bg-accent" /> {label.text ?? label}</span>
                      ))}
                    </div>
                  )}
                </div>
                ...
                <div className="relative rounded-2xl lg:rounded-l-none p-8 sm:p-10 lg:p-12 overflow-hidden flex flex-col" style={{ background: "linear-gradient(160deg, #0E1525 0%, #0B1220 55%, #12102A 100%)", border: "1px solid rgba(148,163,184,0.18)" }}>
                  <div className="hidden lg:flex absolute -left-2 top-0 bottom-0 flex-col items-center justify-around py-6 pointer-events-none">
                    {Array.from({ length: 14 }).map((_, i) => (<span key={i} className="w-3 h-3 rounded-full" style={{ background: "hsl(222 47% 6%)" }} />))}
                  </div>
                  <div className="relative z-10 flex flex-col h-full">
                    <div className="flex items-start justify-between gap-4 mb-7">
                      <div className="text-left">
                        {getStarted.top_label && <p className="text-[10px] font-mono uppercase tracking-[0.2em] text-muted-foreground/70 mb-2">{getStarted.top_label}</p>}
                        {getStarted.heading ? (
                          <h3
                      ...
                      <ul className="relative space-y-4 mb-8 pl-1">
                        {getStartedLists.map((item: any, idx: number) => (
                          <li key={idx} className="relative flex items-start gap-4 group">
                            ...
                            <span className="text-foreground/90 text-sm sm:text-base text-left leading-snug pt-1">{item.list ?? item.text ?? item}</span>
                          </li>
                        ))}
                      </ul>
                    )}
                      ...
                      <div className="text-left">
                        {growthSection.heading && (
                          <h3
                            ...
                            dangerouslySetInnerHTML={{ __html: addClassToSpan(growthSection.heading, "bg-gradient-to-r from-[#5FC2E3] to-[#0077B6] bg-clip-text text-transparent") }}
                          />
                        )}
      ...
      {/* ====== FAQs ====== */}
      {faqs.length > 0 && (
        <section id="faq" ref={setSectionRef("faq")} className="py-12 lg:py-16" style={{ background: "linear-gradient(180deg, hsl(222 47% 6%) 0%, hsl(220 50% 8%) 50%, hsl(222 47% 6%) 100%)" }}>
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className={`text-center mb-10 transition-all duration-700 ${visibleSections.faq ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
              <h2
                className="text-2xl sm:text-3xl lg:text-4xl font-bold text-foreground mb-4"
            ...
            <div className={`max-w-3xl mx-auto transition-all duration-700 ${visibleSections.faq ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`} style={{ transitionDelay: "150ms" }}>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div>
              ...
              {contactSection.paragraph ? (
                <div className="text-muted-foreground mb-6 text-left space-y-4" dangerouslySetInnerHTML={{ __html: contactSection.paragraph }} />
              ) : (

...
const NLP = () => {
  ...
  const servicesSection = pageData?.our_natural_language_processing_services || {};
  const challengesSection = pageData?.ai_cards_section || {};
  ...
  const engagementModelsSection = pageData?.ai_flexible_engagement_models || {};
  ...
  return (
    <>
      ...
      >
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground mb-3" dangerouslySetInnerHTML={{ __html: addClassToSpan(engagementModelsSection.heading || "", "bg-gradient-to-r from-[#5FC2E3] to-[#0077B6] bg-clip-text text-transparent") }}>
            </h2>
            <p className="text-sm sm:text-base text-muted-foreground leading-relaxed max-w-3xl mx-auto">

    ...
    <>
      ...
      >
        <div className="container mx-auto px-4 lg:px-8 relative z-10">
          ...
          <MLOpsServicesEcosystem
            ...
            ariaLabel="AI agent development lifecycle stages"
          />
        </div>
      </section>
      ...
      >
        <div className="container mx-auto px-4 lg:px-8 relative z-10">
          ...
          <MLOpsServicesEcosystem services={technologies} visible={inViewMap.tools} lifecycle={[]} stages={[]} />
        </div>
      </section>
      ...
      >
        <div className="container mx-auto px-4 lg:px-8 relative z-10">
          ...
          <WhyUsBlueprint
            items={whyChoose}
            centerIcon={Bot}
            centerLabel="CODE1 AI AGENTS"
            centerTagline="Autonomous by Design"
            lifecycleLabel={whyChoose[0]?.bottomText}
            ariaLabel="AI agent development and workflow automation capabilities"
          />
        </div>
      </section>

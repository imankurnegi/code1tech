...
import HeroMockup from "@/components/case-studies/simkyc/HeroMockup";
...
interface CaseStudyData {
  ...
  content: {
    ...
    tab_3_fourth_image: string;
    tab_3_fifth_heading: string;
    tab_3_fifth_image: string;
...
interface SimKycCaseStudyProps {
  data: CaseStudyData;
}
...
const SimKycCaseStudy = ({ data }: SimKycCaseStudyProps) => {
  ...
  const kycParagraphs = extractParagraphs(content.tab_3_third_content);
      ...
      <div className="bg-[#07111F]">
        ...
        >
          ...
          <div className={cn(cjContainer, "relative z-10")}>
            <div className="grid items-center gap-12 lg:grid-cols-[6fr_5fr] lg:gap-16">
              ...
              <Reveal delay={180}>
                <HeroMockup className="mx-auto max-w-[520px]" />
              </Reveal>
            </div>
        ...
        >
          ...
          <div className={cn(cjContainer, "relative z-10")}>
            ...
            {/* Connected KYC */}
            <section id="solution-kyc" className={cn("focus:outline-none", blockSpace)}>
              <Reveal delay={60}>
                <SectionTitle className="mb-6">{content.tab_3_third_heading}</SectionTitle>
              </Reveal>
              <div className="space-y-5">
                {kycParagraphs.map((paragraph, i) => (
              ...
              <Reveal delay={360}>
                <Body className="mt-7 max-w-none">
                  {content["tab-3-third-content_2"]}
                </Body>
              </Reveal>
            </section>

            {/* Connected the Pieces */}
            <section id="solution-architecture" className={cn("focus:outline-none", blockSpace)}>
              <Reveal delay={60}>
          ...
          <div className={cjContainer}>
            ...
            <section id="solution-teams" className="focus:outline-none">
              ...
              <div className="grid items-start gap-10 lg:grid-cols-2 lg:gap-14">
                ...
                <div className="space-y-5">
                  {extractParagraphs(content.tab_4_first_right_content).map((paragraph, i) => (
...
export default SimKycCaseStudy;
